...
const damriController = require('../controller/Damri')
...
router.post('/insert', fields, (req, res) => {
  ...
  damriController.insertDamri(data)
    .then((result) => res.json(result))
    .catch((err) => res.json(err))
})

router.get('/getall', (req, res) => {
  damriController.getAllDamri()
    .then(result => res.json(result))
    .catch(err => res.json(err))
})

router.get('/getbyid/:id', (req, res) => {
  damriController.getbyId(req.params.id)
    .then((result) => res.json(result))
    .catch((err) => res.json(err))
})
...
router.put('/edit/:id', fields,(req, res) => {
  ...
  damriController.edit(data, req.params.id, changeImage)
  .then(result => res.json(result))
  .catch(err => res.json(err))
})

router.delete('/delete/:id', (req, res) => {
  damriController.delete(req.params.id)
    .then(result => res.json(result))
    .catch(err => res.json(err))
})
